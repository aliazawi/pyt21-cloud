...
# init
app = Flask(__name__)
conn = pyodbc.connect('Driver={ODBC Driver 17 for SQL Server};Server=tcp:pyt21-sqlserver.database.windows.net,1433;Database=sqldb;Uid=SqlAdmin;Pwd=BytMig123!;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;')
cursor = conn.cursor()
